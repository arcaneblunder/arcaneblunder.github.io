document.addEventListener('DOMContentLoaded', () => {
  ...
  function moveDown() {
	...
	// Change time to variable to increase speed / difficulty as time passes or as score increases?
  ...
  restartBtn.addEventListener('click', location.reload.bind(location));
